...
class MigrationManager:
    ...
    async def migrate_apicache_data(  # pylint: disable=too-many-locals,too-many-nested-blocks
        ...
        try:
            ...
            def _read_legacy() -> list:
                with nowplaying.utils.sqlite.sqlite_connection(str(apicache_db_path)) as conn:
                    cursor = conn.execute(
                        """
            ...
            rows = nowplaying.utils.sqlite.retry_sqlite_operation(_read_legacy)
