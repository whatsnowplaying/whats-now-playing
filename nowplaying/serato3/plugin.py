#!/usr/bin/env python3
"""
Serato 3 Legacy Plugin

This module contains the legacy plugin class for Serato DJ ≤3.
It handles the plugin lifecycle, UI integration, and track polling for both local
Serato libraries and Serato Live playlists using the file-based architecture.
"""
...
class Plugin(InputPlugin):  # pylint: disable=too-many-instance-attributes
    ...
    async def getplayingtrack(self):
        ...
        if self.serato:
            ...
            return await self.serato.getplayingtrack(deckskiplist=deckskip)
        return {}
    ...
    def desc_settingsui(self, qwidget: "QWidget"):
        """description"""
        qwidget.setText(
            "This plugin provides support for Serato DJ ≤ 3  in both a local and remote capacity."
        )
