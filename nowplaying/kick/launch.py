...
def start(
    stopevent: asyncio.Event | None = None, bundledir: str | None = None, testmode: bool = False
) -> None:
...
async def launch_kickbot(
    config: nowplaying.config.ConfigFile | None = None, stopevent: asyncio.Event | None = None
) -> None:
