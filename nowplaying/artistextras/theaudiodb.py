...
class Plugin(ArtistExtrasPlugin):
    ...
    def _fetch(self, apikey: str, api: str) -> t.Optional[dict[str, t.Any]]:
        delay = self.calculate_delay()
        try:
            logging.debug('Fetching %s', api)
            page: requests.Response = requests.get(
                f'https://theaudiodb.com/api/v1/json/{apikey}/{api}', timeout=delay)
        except (
    ...
    def _check_artist(self, artdata: dict[str, t.Any]) -> bool:
    ...
    def _handle_extradata(  # pylint: disable=too-many-branches
            self,
            extradata: list[dict[str, t.Any]],
            metadata: dict[str, t.Any],
            imagecache=None) -> dict[str, t.Any]:
    ...
    def artistdatafrommbid(self, apikey: str, mbartistid: str) -> t.Optional[dict[str, t.Any]]:
    ...
    def artistdatafromname(self, apikey: str, artist: str) -> t.Optional[dict[str, t.Any]]:
