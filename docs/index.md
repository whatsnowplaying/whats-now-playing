...
**Automatically display live track information from your DJ software on streams,
in chat, and anywhere your audience can see it.**

What's Now Playing connects to your DJ software and eliminates the need to
manually update song titles during live streams, radio shows, or DJ sets.
...
Check out the [gallery](gallery/index.md) to see more examples and get
inspiration for your setup.

## Get Started

Begin with the [Quickstart](quickstart.md) to connect your DJ software and
get up and running.
