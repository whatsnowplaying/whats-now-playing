...
discoverable by other **What's Now Playing** instances and compatible applications.
...
| /httpstatic/ | Any content in\`Documents/WhatsNowPlaying/httpstatic\` will get served under this URL. |
