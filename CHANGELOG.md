...
* Twitch no longer throws away your saved login while it is trying to connect.
    ...
    credentials were bad and deleted them. While not signed in that repeated on
    every reconnection attempt, and it could delete a token part-way through
    signing in through the browser. Channel point redemptions and chat were both
    affected
