...
def test_get_authorization_url_scenarios(bootstrap, client_id, redirect_uri,  # pylint: disable=redefined-outer-name
                                         expected_error):
...
@pytest.mark.asyncio
async def test_exchange_code_for_token_scenarios(configured_oauth, mock_responses,  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_refresh_access_token_scenarios(configured_oauth, mock_responses,  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_validate_token_scenarios(configured_oauth, mock_responses, response_status,  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_revoke_token_scenarios(bootstrap, mock_responses, has_client_id, has_token,  # pylint: disable=redefined-outer-name
