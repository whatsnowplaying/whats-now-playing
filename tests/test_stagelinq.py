...
class TestDeckInfo:
    ''' Test DeckInfo dataclass '''

    def test_deckinfo_init_default(self):
    ...
    def test_deckinfo_init_with_values(self):
    ...
    def test_deckinfo_post_init_no_updated(self):
    ...
    def test_deckinfo_less_than_comparison(self):
    ...
    def test_deckinfo_same_content_true(self):
    ...
    def test_deckinfo_same_content_false_different_track(self):
    ...
    def test_deckinfo_same_content_false_different_artist(self):
    ...
    def test_deckinfo_same_content_none_values(self):
...
class TestStagelinqHandler:
    ''' Test StagelinqHandler class '''

    def test_stagelinq_handler_init(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_device_found(self):
        ...
        with patch('nowplaying.inputs.stagelinq.discover_stagelinq_devices') as mock_discover:
            ...
            with patch('nowplaying.vendor.stagelinq.device.AsyncDevice') as mock_async_device:
                ...
                mock_async_device.assert_called_once_with(**vars(mock_device))

    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_device_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_device_exception(self):
    ...
    def test_stagelinq_handler_process_state_update_artist(self):
    ...
    def test_stagelinq_handler_process_state_update_track(self):
    ...
    def test_stagelinq_handler_process_state_update_bpm(self):
    ...
    def test_stagelinq_handler_process_state_update_playing(self):
    ...
    def test_stagelinq_handler_process_state_update_no_deck(self):
    ...
    def test_stagelinq_handler_process_state_update_empty_values(self):
    ...
    def test_stagelinq_handler_update_current_tracks_new_playing(self):
    ...
    def test_stagelinq_handler_update_current_tracks_stopped_playing(self):
    ...
    def test_stagelinq_handler_update_current_tracks_content_changed(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_start(self):
        ''' test start method '''
        event = asyncio.Event()
        handler = StagelinqHandler(event)
        ...
        with patch.object(handler, 'loop', new_callable=AsyncMock) as mock_loop:
            with patch('asyncio.create_task') as mock_create_task:
                ...
                mock_create_task.assert_called_once_with(mock_loop())
                assert handler.loop_task == mock_create_task.return_value

    @pytest.mark.asyncio
    async def test_stagelinq_handler_stop(self):
        ''' test stop method '''
        event = asyncio.Event()
        handler = StagelinqHandler(event)
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_stop_no_task(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_track_newest(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_track_oldest(self):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_handler_get_track_no_decks(self):
...
class TestStagelinqPlugin:
    ''' Test StagelinqPlugin class '''

    @pytest.mark.asyncio
    async def test_stagelinq_plugin_init(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_desc_settingsui(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_install(self, stagelinq_bootstrap):
        ''' test install method '''
        config = stagelinq_bootstrap
        plugin = nowplaying.inputs.stagelinq.Plugin(config=config)
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_validmixmodes(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_setmixmode_valid(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_setmixmode_invalid(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getmixmode(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getplayingtrack_no_handler(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getplayingtrack_no_deck(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getplayingtrack_with_deck(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getplayingtrack_partial_data(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_getrandomtrack(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_start(self, stagelinq_bootstrap):
        ''' test start method '''
        config = stagelinq_bootstrap
        plugin = nowplaying.inputs.stagelinq.Plugin(config=config)
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_stop(self, stagelinq_bootstrap):
        ''' test stop method '''
        config = stagelinq_bootstrap
        plugin = nowplaying.inputs.stagelinq.Plugin(config=config)
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_stop_no_handler(self, stagelinq_bootstrap):
...
class TestStagelinqPluginIntegration:
    ''' Integration tests for StagelinqPlugin '''

    @pytest.mark.asyncio
    async def test_stagelinq_plugin_full_workflow(self, stagelinq_bootstrap):
    ...
    @pytest.mark.asyncio
    async def test_stagelinq_plugin_mixmode_workflow(self, stagelinq_bootstrap):
