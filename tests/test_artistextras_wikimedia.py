...
@pytest.mark.asyncio
async def test_wikimedia_api_call_count(bootstrap, isolated_datacache_client):  # pylint: disable=redefined-outer-name,unused-argument
...
@pytest.mark.asyncio
async def test_wikimedia_failure_cache(bootstrap, isolated_datacache_client):  # pylint: disable=redefined-outer-name,unused-argument
