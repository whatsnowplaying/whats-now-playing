...
@pytest.mark.asyncio
async def test_wikimedia_api_call_count(bootstrap, temp_api_cache):  # pylint: disable=redefined-outer-name
...
@pytest.mark.asyncio
async def test_wikimedia_failure_cache(bootstrap, temp_api_cache):  # pylint: disable=redefined-outer-name
