...
def test_files(getroot) -> dict[str, list[str]]:
    ...
    return {
        "basic": [
            audio_dir / "15_Ghosts_II_64kb_orig.mp3",
            audio_dir / "15_Ghosts_II_64kb_orig.flac",
            audio_dir / "15_Ghosts_II_64kb_orig.m4a",
            audio_dir / "15_Ghosts_II_64kb_orig.aiff",
        ],
        "complex": [
...
def test_corrupted_file_handling(tmp_path):
    ...
    corrupt_test_files = [
        (tmp_path / "corrupt.mp3", b"not mp3 data"),
