...
class TestChatUtilities:
    """Test shared chat utility functions"""

    def test_ensure_nltk_data_already_available(self):
    ...
    def test_ensure_nltk_data_download_needed(self):
    ...
    def test_ensure_nltk_data_download_fails(self):
    ...
    def test_smart_split_message_short_message(self):
    ...
    def test_smart_split_message_sentence_boundaries(self):
    ...
    def test_smart_split_message_word_boundaries(self):
        """Test message splitting at word boundaries for long sentences"""
        message = "This is a very long sentence that exceeds the maximum length limit and should be split at word boundaries"
        ...
        for part in result:
            ...
            if not part.endswith('...'):
                assert ' ' not in part or part.count(' ') > 0  # Either single word or multiple complete words

    def test_smart_split_message_very_long_word(self):
    ...
    def test_smart_split_message_mixed_content(self):
        """Test message splitting with mixed sentence and word content"""
        message = "Short sentence. This is a much longer sentence that will need to be split at word boundaries because it exceeds the limit. Final short sentence."
    ...
    def test_smart_split_message_nltk_failure_fallback(self):
    ...
    def test_smart_split_message_empty_parts_removed(self):
    ...
    def test_smart_split_message_preserve_content(self):
    ...
    def test_tokenize_sentences_success(self):
    ...
    def test_tokenize_sentences_fallback(self):
    ...
    def test_smart_split_message_various_limits(self, max_length):
        """Test message splitting with various length limits"""
        message = "This is a test message with multiple sentences. Each sentence should be handled based on the length limit. The splitting should work correctly."
    ...
    def test_smart_split_message_default_limit(self):
    ...
    def test_smart_split_message_unicode_handling(self):
        """Test message splitting handles Unicode characters correctly"""
        message = "This message contains émojis 🎵 and spëcial characters. Ït should be handled correctly! 中文 text as well."
